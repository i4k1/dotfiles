...
static const char col_gray3[]       = "#f5f5dc";
...
static const char *termcmd[]  = { "xterm", "-fg", "beige", "-bg", "black", "+sb", "-tn", "xterm-256color", "-fa", "Liberation Mono:pixelsize=16:antialias=true:autohint=true", NULL };
